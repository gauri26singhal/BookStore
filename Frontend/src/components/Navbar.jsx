...
function Navbar() {
  ...
  const handleSearch = (e) => {
    ...
    navigate("/results", { state: { filteredBooks } }); 
    setSearchQuery(""); 
  };
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky ? "bg-base-200 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
  ...
  <svg
    ...
    onClick={() => {
      ...
      document.querySelector(".swap").classList.toggle("swap-active");
    }}
  >
    {/* Sun icon */}
  </svg>
            ...
            <div className="hidden md:block">
              <form onSubmit={handleSearch} className="flex items-center">
                <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                  <input
                    type="text"
                    className="grow outline-none rounded-md px-1 dark:bg-slate-900 dark:text-white p-4"
